...
void process_shaders() {
    ...
    string_to_spv("dsv4_hc_pre_f32",  "dsv4_hc_pre.comp",  base_dict);
    string_to_spv("dsv4_hc_comb_f32", "dsv4_hc_comb.comp", base_dict);
    string_to_spv("dsv4_hc_post_f32", "dsv4_hc_post.comp", base_dict);
