...
void process_shaders() {
    ...
    string_to_spv("dsv4_hc_pre_vitriol_f32",  "dsv4_hc_pre_vitriol.comp",  base_dict);
    string_to_spv("dsv4_hc_comb_vitriol_f32", "dsv4_hc_comb_vitriol.comp", base_dict);
    string_to_spv("dsv4_hc_post_vitriol_f32", "dsv4_hc_post_vitriol.comp", base_dict);
